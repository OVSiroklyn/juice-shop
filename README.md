...
| ![Знімок 1](_Файли/Знімок_20260504_190417.png) | ![Знімок 2](_Файли/Знімок_20260505_011546.png) |
| :---: | :---: |

  - Запустити застосунок, за допомогою `npm install` -> `npm start`.  

| ![Знімок 3](_Файли/Знімок_20260505_011359.png) |
| :---: |
...
| ![Налаштування SonarCloud](_Файли/Pasted%20image%2020260505145427.png) |
| :---: |

  - Додати токен доступу `SONAR_TOKEN` до секретів GitHub.  

| ![Додавання токена](_Файли/Pasted%20image%2020260505145701.png) |
| :---: |
